...
ROOT_URLCONF = 'group_donations.urls'
...
WSGI_APPLICATION = 'group_donations.wsgi.application'
...
if os.getenv('DEBUG') == 'True' or 'true':
    ...
    DATABASES = {
        'default': {
            ...
            'PASSWORD': os.getenv('POSTFRES_PASSWORD', 'password'),
...
AUTH_USER_MODEL = 'collect_payments.CustomUser'
...
DEFAULT_FROM_EMAIL = os.getenv('PROJECT_EMAIL', 'group_donations@example.com')
